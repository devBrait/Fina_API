...
namespace Fina.Api.Handlers
{
    public class TransactionHandler(AppDbContext context) : ITransactionHandler
    {
        ...
        public async Task<Response<Transaction?>> UpdateAsync(UpdateTransactionRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, "Erro ao editar transação"); 
            }
        }
        ...
        public async Task<PagedResponse<List<Transaction>?>> GetByPeriodAsync(GetTransactionsByPeriodRequest request)
        {
            ...
            {
                return new PagedResponse<List<Transaction>?>(null, 500, "Erro ao listar as transações");
            }
        }
        ...
        public async Task<Response<Transaction?>> GetByIdAsync(GetTransactionByIdRequest request)
        {
            ...
            {
                return new Response<Transaction?>(null, 500, "Erro ao listar transação!");
            }
        }
    }
}
